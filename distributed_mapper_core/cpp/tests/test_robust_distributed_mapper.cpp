...
TEST_DISABLED(DistributedMapper, testdistributedEstimationWithOutliersNoRotation_2robots) {
    // Parameters
...
TEST_DISABLED(DistributedMapper, testdistributedEstimationWithoutOutliersWithRotation_2robots) {
    // Parameters
    size_t nrRobots = 2; // number of robots
    string logDir("/tmp/"); // log directory
...
TEST_DISABLED(DistributedMapper, testdistributedEstimationWithOutliersWithRotation_2robots) {
    // Parameters
    size_t nrRobots = 2; // number of robots
    string logDir("/tmp/"); // log directory
...
TEST_DISABLED(DistributedMapper, testdistributedEstimationWithOutliersWithRotationNoPCM_2robots) {
    // Parameters
    size_t nrRobots = 2; // number of robots
    string logDir("/tmp/"); // log directory
    string dataDir("../../../test_data/pairwise_consistency_maximization/spoiled/simulation/example_2robots/"); // data directory
