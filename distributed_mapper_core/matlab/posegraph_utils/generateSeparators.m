function [measurements, edges_id] = generateSeparators(robot_poses, node_offset_robot1, node_offset_robot2, number_of_separators, trajectory_size, sigma_R, sigma_t, information_matrix)
